...
- 图片：`/Users/galw/.openclaw/media/tool-image-generation/`
- 视频：`/Users/galw/.openclaw/media/tool-video-generation/`
...
for p in d['candidates'][0]['content']['parts']:
    if 'inlineData' in p:
        ...
        open(f'/Users/galw/.openclaw/media/tool-image-generation/gemini-{int(time.time())}.png','wb').write(img)
...
urllib.request.urlretrieve(d['data'][0]['url'],
  f'/Users/galw/.openclaw/media/tool-image-generation/grok-{int(time.time())}.png')
print('saved')
"
```
...
**下载保存：**
```bash
curl -L -o "/Users/galw/.openclaw/media/tool-video-generation/veo3.mp4" "{result_url}"
```
